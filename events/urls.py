...
urlpatterns = [
    ...
    path('<int:event_id>/duplicate/', views.duplicate_event, name='duplicate'),
    path('<int:event_id>/publish/', views.publish_event, name='publish'),
    path('<int:event_id>/unpublish/', views.unpublish_event, name='unpublish'),
